...
(library (sdl ftype)
 ...
 (define-ftype SDL_AudioDeviceID
  ...
  (define SDL_DequeueAudio          (sdl-procedure "SDL_DequeueAudio" (SDL_AudioDeviceID u8* unsigned-32) unsigned-32))
  ...
  (define SDL_SetSurfaceAlphaMod             (sdl-procedure "SDL_SetSurfaceAlphaMod" ((* SDL_Surface) unsigned-8) int))
  ...
  (define SDL_Vulkan_LoadLibrary              (sdl-procedure "SDL_Vulkan_LoadLibrary" (string) int))
