...
(library (sdl ftype)
  ...
  (define-ftype SDL_HapticEffect
    (struct (type       unsigned-16)
	    ...
	    (ramp       SDL_HapticRamp)
	    (left-right SDL_HapticLeftRight)
  ...
  (define SDL_GetAudioDeviceStatus  (sdl-procedure "SDL_GetAudioDeviceStatus" () void))
  ...
  (define SDL_PauseAudioDevice      (sdl-procedure "SDL_PauseAudioDevice" () void))
